...
interface SacredCircuitSectionProps {
  className?: string;
}

const SacredCircuitSection = ({ className = '' }: SacredCircuitSectionProps) => {
  ...
  const includedItems = [
    'Hotels, transport, permits',
    'Daily heritage briefings',
  ...
  return (
    ...
    >
      ...
      >
        <Sun className="w-7 h-7 text-gold" strokeWidth={1.5} />
      </div>

      {/* Headline Block (Left) */}
      <div
        ref={headlineBlockRef}
        className="absolute left-[8vw] top-1/2 -translate-y-1/2 z-10 max-w-[34vw]"
      >
        <span className="eyebrow block mb-4">THE SACRED CIRCUIT</span>
        <h2 className="font-serif text-h2 text-text-primary mb-6">
          Nankana Sahib •<br />
          Kartarpur •<br />
          Panja Sahib
        </h2>
        <p className="text-text-secondary leading-relaxed mb-8 max-w-[30vw]">
          Five days of kirtan, langar, and reflection—guided by historians, 
          supported by a team that handles every border detail.
        </p>
        <a
          href="#itinerary"
      ...
      <div
        ref={cardRef}
        className="absolute right-[6vw] bottom-[14vh] z-10 w-[22vw] min-w-[280px]"
      >
...
export default SacredCircuitSection;